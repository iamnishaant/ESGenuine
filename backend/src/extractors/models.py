...
class ExtractedClaim(BaseModel):
    ...
    # Regulatory framework clause IDs this claim reports against (frameworks.py):
    # e.g. ["GRI 305-1", "ESRS E1-6", "TCFD Metrics & Targets"]. Deterministic,
    # assigned by the quality gate after the aspect label is final.
